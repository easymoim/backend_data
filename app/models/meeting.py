...
class Meeting(Base):
    ...
    # location_choice_type: PostgreSQL ENUM 타입 사용
    location_choice_type = Column(
        ENUM(LocationChoiceType, name='location_choice_type_enum', create_type=False, values_callable=lambda x: [e.value for e in x]),
        nullable=True
    )
